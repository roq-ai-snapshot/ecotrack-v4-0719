...
function HomePage() {
  return (
    <>
      <Head>
        <title>EcoTrack v4</title>

        <meta
          name="description"
          content="Elevate Your Sustainability Journey with EcoTrack v4: The Ultimate Environmental Data Management Platform for Monitoring Carbon Footprint, Managing Waste, and Adopting Sustainable Practices."
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Elevate Your Sustainability Journey with EcoTrack v4: The Ultimate Environmental Data Management Platform for Monitoring Carbon Footprint, Managing Waste, and Adopting Sustainable Practices.`}
            </Text>
